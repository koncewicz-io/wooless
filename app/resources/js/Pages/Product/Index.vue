<template>
    ...
    <AppLayout :cart="cart" :logged="logged">
        ...
        <div class="border-b border-gray-200 pb-10 pt-24">
            <h1 class="text-4xl font-bold tracking-tight text-gray-900">{{ i18n.global.t('new_arrivals') }}</h1>
            <p class="mt-4 text-base text-gray-500">{{ i18n.global.t('new_arrivals_description') }}</p>
        </div>
                        ...
                        <div class="flex flex-1 flex-col space-y-2 p-4">
                            ...
                            <div class="flex flex-1 flex-col justify-end">
                                ...
                                <p class="text-base font-medium text-gray-900">
                                    <span v-if="product.prices.currency_prefix" v-html="product.prices.currency_prefix"></span>{{ product.formated_prices.price }}<span v-if="product.prices.currency_suffix" v-html="product.prices.currency_suffix"></span>
                                </p>
                            </div>
                        </div>
                    </div>
...
const messages = {
    en: {
        ...
        new_arrivals_description: 'Discover our latest products – stylish T-Shirts, trendy sunglasses, and comfortable hoodies.',
        filters: 'Filters'
    },
    pl: {
        head_title: 'Produkty',
        new_arrivals: 'Nowości',
        new_arrivals_description: 'Odkryj nasze najnowsze produkty – stylowe T-Shirty, modne okulary przeciwsłoneczne i wygodne bluzy z kapturem.',
        filters: 'Filtry'
    }
};
